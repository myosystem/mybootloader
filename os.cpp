...
int8_t* inputbuffer = (int8_t*)0x400000;
...
uint8_t* console = (uint8_t*)0x300000;
extern "C" void main() {
    ...
    init_interrupts();
    static volatile BootInfo* gGraphicsInfo = (BootInfo*)0x200000;
    for (i = 0; i < gGraphicsInfo->framebufferWidth * gGraphicsInfo->framebufferHeight; i++) {
        static volatile uint8_t Red = 255;
        static volatile uint8_t Green = 255;
        static volatile uint8_t Blue = 255;

        static volatile uint32_t PixelColor = (Red << 16) | (Green << 8) | Blue;
        *((uint32_t*)(gGraphicsInfo->framebufferAddr) + i) = PixelColor;
    }
    static volatile Frame mainframe = {0x500000,gGraphicsInfo->framebufferWidth,gGraphicsInfo->framebufferHeight};
    static volatile int console_x = 0;
    static volatile int console_y = 0;
    while(1) {
